...
f_R1_lens = f_soln3_R1_edmund_warm # focal length of first relay lens (mm)
loc_R2_lens = 223.85
f_R2_lens = f_soln3_R2_edmund_warm # focal length of second relay lens (mm)
...
plt.suptitle("lens 1 physical f = " + str(f_R1_lens) + " mm\nM_total = "+str(np.round(mag_final,4)) + " (" + str(np.round(mag_final_rel,4)) +" relative to optimal)")
